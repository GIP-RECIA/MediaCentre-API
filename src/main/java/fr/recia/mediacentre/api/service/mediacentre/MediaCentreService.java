...
public interface MediaCentreService {
     ...
     */
    Optional<Ressource> retrieveRessourceByName(String ressourceId, List<String> isMemberOf, boolean isBase64, boolean forCurrentEtab) throws YmlPropertyNotFoundException, MediacentreWSException;
