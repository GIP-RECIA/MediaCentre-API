...
public class MediaCentreConfiguration {
    ...
    public MediaCentreService localFileFilterImpl() {
        return new MediaCentreServiceMockWithUAIFilterImpl(soffitHolder, mappingProperties, categoriesByProfilesProperties);
    }
